...
# An expected list showing the standard street types that do not need to be cleaned
expected = ["Street", "Avenue", "Boulevard", "Drive", "Court", "Place", "Square", "Road", 
            "Parkway", "Plaza", "Broadway", "Circle", "Driveway", "Highway", "Park", "Lane"]

# The unexpected street types that need to be fixed to the appropriate
...
def audit_street_type(street_types, street_name):
    """
       ...
       within the expected list, then stores them in street_types dictionary
    """
...
# a "start" event can only be used to inspect the attributes, not the element content 
